    ...
    useEffect(() => {
        ...
        gsap.from('.upper-section', {
            scrollTrigger: {
              ...
              start: 'top top', // начать анимацию, когда верхнее центральное положение контейнера достигнуто верхним краем окна просмотра
              end: '1000px', // закончить анимацию, когда нижнее центральное положение контейнера достигнуто нижним краем окна просмотра
              pin: ".upper-section"
            }, 
          });
    })
